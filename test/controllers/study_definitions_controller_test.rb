...
#  include Devise::TestHelpers 
  ...
  setup do
    ...
    @user = users(:one)
    @dk_app = Doorkeeper::Application.create!(:name => 'MyApp', :redirect_uri => 'https://app.com')
  ...
  test "should get index" do
    get study_definitions_url, as: :json
    assert_response :success
  end

  test "should get new" do
    get new_study_definition_url, as: :json
    assert_response :success
  end

  test "should create study_definition" do
    assert_difference('StudyDefinition.count') do
      post study_definitions_url, params: { title: "test post", principal_investigator_user_id: 0 }, :as => :json
    end
  ...
  test "should show study_definition" do
    get study_definition_url(@study_definition), as: :json
    assert_response :success
  end

  test "should get edit" do
    get edit_study_definition_url(@study_definition), as: :json
    assert_response :success
  end

  test "should update study_definition" do
    patch study_definition_url(@study_definition), params: { title: "new" }, :as => :json
    assert_response :success
  end

  test "should destroy study_definition" do
    assert_difference('StudyDefinition.count', -1) do
      delete study_definition_url(@study_definition), :as => :json
    end
