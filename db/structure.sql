CREATE TABLE IF NOT EXISTS "chaos_sessions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "session_guid" varchar NOT NULL, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "phase_definition_id" integer, "trial_definition_id" integer, "protocol_user_id" integer, "study_result_id" integer, "experiment_id" integer, "stage_id" integer, "trial_result_id" integer, "preview" boolean, "url" varchar NOT NULL, "expires_at" datetime NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE sqlite_sequence(name,seq);
CREATE TABLE IF NOT EXISTS "components" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "definition_data" varchar, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "phase_definition_id" integer NOT NULL, "trial_definition_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "media_files" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "file" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "oauth_applications" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "uid" varchar NOT NULL, "secret" varchar NOT NULL, "redirect_uri" text NOT NULL, "scopes" varchar DEFAULT '' NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE UNIQUE INDEX "index_oauth_applications_on_uid" ON "oauth_applications" ("uid");
CREATE TABLE IF NOT EXISTS "phase_orders" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "sequence_data" varchar, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "user_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "protocol_definitions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "version" integer, "type" varchar, "summary" varchar, "description" varchar, "definition_data" varchar, "active" boolean DEFAULT 'f' NOT NULL, "study_definition_id" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE INDEX "index_protocol_definitions_on_study_definition_id" ON "protocol_definitions" ("study_definition_id");
CREATE TABLE IF NOT EXISTS "protocol_users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "group_name" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "stimuli" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "definition_data" varchar, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "phase_definition_id" integer NOT NULL, "trial_definition_id" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "study_result_contexts" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "datetime" datetime, "context_type" text, "data" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE IF NOT EXISTS "study_result_data_points" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "stage_id" integer NOT NULL, "protocol_user_id" integer, "phase_definition_id" integer, "trial_definition_id" integer, "component_id" integer, "kind" varchar, "point_type" varchar, "value" varchar, "method" varchar, "datetime" datetime, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "study_result_experiments" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "study_result_id" integer NOT NULL, "protocol_user_id" integer NOT NULL, "current_stage_id" integer, "num_stages_completed" integer, "num_stages_remaining" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "started_at" datetime, "completed_at" datetime, "custom_parameters" jsonb);
CREATE INDEX "index_study_result_experiments_on_protocol_user_id" ON "study_result_experiments" ("protocol_user_id");
CREATE TABLE IF NOT EXISTS "study_result_stages" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "experiment_id" integer NOT NULL, "protocol_user_id" integer NOT NULL, "phase_definition_id" integer NOT NULL, "last_completed_trial" integer, "current_trial" integer, "num_trials" integer, "context_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "started_at" datetime, "completed_at" datetime);
...
CREATE TABLE IF NOT EXISTS "study_result_study_results" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "study_definition_id" integer, "user_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "started_at" datetime, "completed_at" datetime);
...
CREATE TABLE IF NOT EXISTS "study_result_time_series" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "stage_id" integer, "study_definition_id" integer, "protocol_definition_id" integer, "phase_definition_id" integer, "component_id" integer, "file" varchar, "schema" varchar, "schema_metadata" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "study_result_trial_results" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "experiment_id" integer NOT NULL, "protocol_user_id" integer NOT NULL, "phase_definition_id" integer NOT NULL, "trial_definition_id" integer NOT NULL, "session_name" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "started_at" datetime, "completed_at" datetime);
...
CREATE TABLE IF NOT EXISTS "trial_definitions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "definition_data" varchar, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "phase_definition_id" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "name" varchar, "description" varchar);
...
CREATE TABLE IF NOT EXISTS "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar DEFAULT '' NOT NULL, "encrypted_password" varchar DEFAULT '' NOT NULL, "reset_password_token" varchar, "reset_password_sent_at" datetime, "remember_created_at" datetime, "sign_in_count" integer DEFAULT 0 NOT NULL, "current_sign_in_at" datetime, "last_sign_in_at" datetime, "current_sign_in_ip" varchar, "last_sign_in_ip" varchar, "confirmation_token" varchar, "confirmed_at" datetime, "confirmation_sent_at" datetime, "unconfirmed_email" varchar, "anonymous" boolean, "role" varchar, "username" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE IF NOT EXISTS "schema_migrations" ("version" varchar NOT NULL PRIMARY KEY);
CREATE TABLE IF NOT EXISTS "ar_internal_metadata" ("key" varchar NOT NULL PRIMARY KEY, "value" varchar, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE IF NOT EXISTS "phase_definitions" ("id" integer NOT NULL PRIMARY KEY, "definition_data" varchar DEFAULT NULL, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "trial_ordering" varchar);
...
CREATE TABLE IF NOT EXISTS "trial_order_selection_mappings" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "trial_order_id" integer, "user_id" integer, "phase_definition_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, CONSTRAINT "fk_rails_8c4c7d984f"
...
CREATE TABLE IF NOT EXISTS "trial_orders" ("id" integer NOT NULL PRIMARY KEY, "sequence_data" varchar DEFAULT NULL, "study_definition_id" integer NOT NULL, "protocol_definition_id" integer NOT NULL, "phase_definition_id" integer NOT NULL, "user_id" integer DEFAULT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE IF NOT EXISTS "study_definitions" ("id" integer NOT NULL PRIMARY KEY, "title" varchar DEFAULT NULL, "description" varchar DEFAULT NULL, "principal_investigator_user_id" integer NOT NULL, "version" integer DEFAULT NULL, "data" text DEFAULT NULL, "lock_question" integer DEFAULT NULL, "enable_previous" integer DEFAULT NULL, "no_of_trials" integer DEFAULT NULL, "trials_completed" integer DEFAULT NULL, "footer_label" text DEFAULT NULL, "redirect_close_on_url" varchar DEFAULT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "AllowAnonymousUsers" boolean DEFAULT NULL, "ShowInStudyList" boolean DEFAULT NULL, "allow_anonymous_users" boolean, "show_in_study_list" boolean, "max_anonymous_users" integer);
