...
module Api::V1
  class StudyDefinitionsController < ApiController
    ...
    def index
      ...
      resources = StudyDefinition.includes({:protocol_definitions => :phase_definitions}).joins(:principal_investigator)
      ...
      respond_with instance_variable_get(plural_resource_name), :include => [:principal_investigator, {:protocol_definitions => {:include => :phase_definitions } } ]
    end
