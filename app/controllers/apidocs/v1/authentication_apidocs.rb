    ...
    class AuthenticationApidocs
      ...
      swagger_schema :AuthRequestInput do
        ...
        property :grant_type do
          key :description,
              "OAuth grant type, valid values: 'password' (for username/password login), 'client_credentials' (for initial client app authentication) and 'refresh_token' for token refresh."
          key :type, :string
